...
VALUES 
  ('Ahri', 'Spirit Rush - Ahri dashes around the battlefield, damaging enemies she passes through.', 2,  '1,3,5', '1', '2,5'),
  ('Darius', 'Dreadnova Guillotine - Darius leaps to the farthest enemy, dealing damage and executing targets below a threshold.', 3,  '2,4', '2', '1,3'),
  ('Ezreal', 'Trueshot Barrage - Ezreal channels for a few seconds, firing a barrage of missiles towards the enemy with the highest current health.', 4,  '3,4,5', '1', '4'),
  ('Katarina', 'Death Lotus - Katarina spins and throws daggers at the nearest enemies, dealing damage and reducing healing.', 5,  '1,2,3,4,5', '2', '1');
